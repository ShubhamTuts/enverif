...
@php
    ...
    $runtimeCssMtime = @filemtime(public_path('assets/runtime-ui.css'));
    ...
    $runtimeCssVersion = $runtimeCssMtime ? $assetVersion.'-'.$runtimeCssMtime : $assetVersion;
@endphp
...
<link rel="stylesheet" href="{{ asset('assets/runtime-ui.css') }}?v={{ rawurlencode($runtimeCssVersion) }}">
