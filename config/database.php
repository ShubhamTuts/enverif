...
return [
    ...
    'connections' => [
        'mysql' => [
            ...
            'database' => env('DB_DATABASE', 'enverif'), 'username' => env('DB_USERNAME', 'root'), 'password' => env('DB_PASSWORD', ''),
    ...
    'redis' => [
        'client' => env('REDIS_CLIENT', 'phpredis'), 'options' => ['cluster' => env('REDIS_CLUSTER', 'redis'), 'prefix' => env('REDIS_PREFIX', Str::slug(env('APP_NAME', 'enverif'), '_').'_database_')],
